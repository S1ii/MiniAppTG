...
INSERT INTO "new_Comment" ("authorId", "authorUsername", "content", "createdAt", "gossipId", "id", "replyToId") SELECT "authorId", "authorUsername", "content", "createdAt", "gossipId", "id", "replyToId" FROM "Comment";
DROP TABLE "Comment";
